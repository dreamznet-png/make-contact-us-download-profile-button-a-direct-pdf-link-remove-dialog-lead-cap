...
export function ControlLeadGenForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await sendFormEmail(
      `CONTROL™ Framework Request – ${formData.companyName}`,
      {
  ...
  if (submitted) {
    return (
      <div
        ...
        data-ocid="control_form.success_state"
      >
    ...
    >
      <div className="grid md:grid-cols-2 gap-6 mb-6">
        <div>
          ...
          <Input
            ...
            data-ocid="control_form.firstName.input"
          />
          {errors.firstName && (
        ...
        <div>
          ...
          <Input
            ...
            data-ocid="control_form.lastName.input"
          />
          {errors.lastName && (
      ...
      <div className="mb-6">
        ...
        <Input
          ...
          data-ocid="control_form.companyName.input"
        />
        {errors.companyName && (
        ...
        <div>
          ...
          >
            <SelectTrigger
              ...
              data-ocid="control_form.industry.select"
            >
        ...
        <div>
          ...
          >
            <SelectTrigger
              ...
              data-ocid="control_form.revenueRange.select"
            >
      ...
      <div className="mb-6">
        ...
        <Textarea
          ...
          rows={4}
          data-ocid="control_form.challenge.textarea"
        />
        {errors.challenge && (
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-6">
        <div>
          ...
          <Input
            ...
            data-ocid="control_form.email.input"
          />
          {errors.email && (
        ...
        <div>
          ...
          <Input
            ...
            data-ocid="control_form.mobile.input"
          />
          {errors.mobile && (
      ...
      {submitError && (
        <p
          ...
          data-ocid="control_form.error_state"
        >
          {submitError}
        </p>
      )}
      <Button
        ...
        data-ocid="control_form.submit_button"
      >
        {isSubmitting ? (
          <>
